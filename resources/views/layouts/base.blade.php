                                        ...
                                        @if (Route::has('login'))
                                            @auth
                                                ...
                                                <ul class="dropdown-menu ">
                                                    <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-desktop"></i> Dasboard</a></li>
                                                ...
                                                @else
                                                <ul class="dropdown-menu ">
                                                    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-desktop"></i> Dashboard</a></li>
                                                    <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-lock"></i> Logout</a></li>
                                                    <form id="logout-form" method="post" action="{{ route('logout') }}">
                                                        @csrf
                                                    </form>
                                                        ...
                                                        @auth
                                                            ...
                                                            <li class="">
                                                                ...
                                                                <a href="{{ route('user.dashboard') }}" class="clearfix">
                                                                    <strong>Hi, {{ Auth::user()->name }} <i class="fa fa-desktop"></i></strong>
                                                                    <span class="label"></span>
                                                                </a>
                                                            </li>
                                                            <li class="">
