...
<head>
    ...
    <title>Avichs</title>
    <meta charset="utf-8">
    <meta name="keywords" content="humidifier, dehumidifier, radio, sound system, home theater, furniture, bluetooth speaker, fridges, freezers, avichs" />
    <meta name="author" content="Avichs">
                                            ...
                                            <ul class="tab-content content dropdown-menu pull-right shoppingcart-box" role="menu">                          
                                                ...
                                                <li>
                                                    <div>
                                                        ...
                                                        <p class="text-center"> <a class="btn view-cart" href="{{ route('product.cart') }}"><i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="{{ route('checkout') }}"><i class="fa fa-share"></i>Checkout</a> </p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
