    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Coupons</h4>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="updateCoupon" class="form-material m-t-40">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Update Coupon" class="btn btn-info form-control-line"> 
                            </div>
                        </form>
                    </div>
                </div>
