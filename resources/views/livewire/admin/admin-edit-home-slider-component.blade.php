            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="updateSlide" enctype="multipart/form-data"  class="form-material m-t-40">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <img src="{{ asset('asset/image/sliders') }}/{{ $image }}" width="120" alt="">
                                    @endif
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="submit" value="Update Slider" class="btn btn-info form-control-line"> 
                                </div>
                        </form>
                    </div>
                </div>
