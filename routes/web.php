...
use App\Http\Livewire\PaystackCheckoutComponent;
...
use App\Http\Livewire\Admin\AdminCouponsComponent; //AdminCouponsComponent
...
Route::get('/paystackcheckout', PaystackCheckoutComponent::class)->name('paystack');
Route::get('/contact', ContactComponent::class);
Route::get('/product/{slug}', DetailsComponent::class)->name('product.details');
Route::get('/product-category/{category_slug}', CategoryComponent::class)->name('product.category');
Route::get('/search', SearchComponent::class)->name('product.search');
Route::get('/thank-you', ThankyouComponent::class)->name('thankyou');
Route::post('/pay', PayComponent::class)->name('pay');
Route::get('/payment/callback', PayComponent::class);
